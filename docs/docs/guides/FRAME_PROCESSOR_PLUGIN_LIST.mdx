...
* [mat2718/**vision-camera-mrz-scanner**](https://github.com/mat2718/vision-camera-mrz-scanner): Plugin to detect and read MRZ data from passports using MLKit Text Recognition (free).

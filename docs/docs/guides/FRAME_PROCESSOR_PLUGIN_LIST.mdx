...
* [mat2718/**vision-camera-face-detector**](https://github.com/mat2718/vision-camera-face-detector): An updated plugin to detect faces using MLKit. Includes helper functions, updated dependencies, and basic/ andvanced examples.
